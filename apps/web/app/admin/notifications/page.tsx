...
export default function NotificationsPage() {
 ...
 <div className="flex flex-col items-center justify-center rounded-3xl border border-gray-200 bg-white py-16 text-gray-400">
 ...
 <button onClick={() => setShowSend(false)} className="rounded-xl p-2 text-gray-400 hover:bg-gray-200">
 <Send size={18} />
 </button>
 </div>
 ...
 <input required value={sendForm.title} onChange={e => setSendForm(p => ({ ...p, title: e.target.value }))} className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div>
 <label className="mb-1.5 block text-sm font-medium text-gray-700">Message *</label>
 <textarea required value={sendForm.body} onChange={e => setSendForm(p => ({ ...p, body: e.target.value }))} rows={3} className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div>
 <label className="mb-1.5 block text-sm font-medium text-gray-700">User ID (leave empty to broadcast)</label>
 <input value={sendForm.userId} onChange={e => setSendForm(p => ({ ...p, userId: e.target.value }))} placeholder="Leave empty for all users" className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div className="flex justify-end gap-3 pt-2">
 <button type="button" onClick={() => setShowSend(false)} className="rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Cancel</button>
