...
export default function MessagesPage() {
 ...
 <div className="rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-gray-800">
 ...
 className={`w-full px-5 py-4 text-left transition-colors hover:bg-gray-50 ${selectedId === c.id ? 'bg-red-200/50' : ''}`}
 >
 ...
 <div className="flex h-[70vh] flex-col rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-gray-800">
 {!selectedConvo ? (
 ...
 <button onClick={() => setSelectedId(null)} className="rounded-lg p-1 text-gray-400 hover:bg-gray-100 lg:hidden">
 <ArrowLeft size={18} />
 </button>
 ...
 <div>
 <p className="font-semibold text-gray-900">{selectedConvo.studentName || 'Unknown'}</p>
 ...
 <div className={`max-w-[75%] rounded-2xl px-4 py-2.5 ${msg.senderRole === 'STUDENT' ? 'bg-gray-100' : 'bg-primary/10'}`}>
