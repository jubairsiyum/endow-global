...
export default function UniversitiesPage() {
 ...
 <div className="space-y-2"><div className="h-4 w-32 animate-pulse rounded bg-gray-200" /></div>
 ...
 <input required value={form.country} onChange={e => updateField('country', e.target.value)} placeholder="e.g. South Korea" className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div>
 ...
 <input value={form.website} onChange={e => updateField('website', e.target.value)} placeholder="https://..." className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div>
 <label className="mb-1.5 block text-sm font-medium text-gray-700">Established (Year)</label>
 <input type="number" value={form.established} onChange={e => updateField('established', e.target.value)} placeholder="e.g. 1978" className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm outline-none focus:border-primary" />
 </div>
 <div>
