      ...
      <AdminTable>
        <div className="overflow-x-auto">
          ...
          {universities.map((university, index) => (
            ...
            >
              <div className="font-semibold text-gray-900 dark:text-white">{university.name}</div>

              <div className="text-gray-700 dark:text-gray-300">{university.country}</div>

              <div className="text-gray-700 dark:text-gray-300">{university.students}</div>
