...
export default async function RevenuePage() {
 ...
 <p className="text-xs text-gray-500">Track platform revenue from consultations and applications</p>
 </div>
 </div>
 </div>
 ...
 <div
 key={stat.label}
 className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800"
 >
 ...
 <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800">
