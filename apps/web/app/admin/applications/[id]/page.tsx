      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-[#1a1d25]">
            ...
            <div className="mt-6">
              <p className="text-sm text-gray-500 mb-2">Personal Statement</p>
              ...
              <ul className="space-y-2">
                {app.documentsUrls.map((docUrl: any, idx: number) => (
                  <li key={idx} className="flex items-center gap-2">
                    <a href={docUrl} target="_blank" rel="noreferrer" className="text-sm text-primary hover:underline">
                      Document {idx + 1}
                    </a>
                  </li>
                ))}
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-[#1a1d25]">
            ...
            {statusMutation.isPending && <p className="text-xs text-primary mt-2">Updating...</p>}
          </div>

          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-[#1a1d25]">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Counselor Notes</h2>
