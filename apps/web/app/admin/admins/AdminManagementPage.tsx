...
export default function AdminManagementPage() {
 ...
 <p className="text-xs text-gray-500">Manage platform administrators and their roles</p>
 </div>
 </div>
 </div>

 <div className="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800">
 ...
 className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 hover:text-amber-500"
 ...
 className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 hover:text-blue-500"
