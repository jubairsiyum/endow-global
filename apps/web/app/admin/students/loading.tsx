export default function StudentsLoading() {
 ...
 <div className="h-4 w-56 rounded-lg bg-gray-200" />
 </div>
 </div>
 ...
 {/* Table skeleton */}
 <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-gray-800">
 <div className="overflow-x-auto">
 {/* Table header */}
 <div className="grid min-w-[900px] grid-cols-5 border-b border-gray-100 bg-gray-50 px-6 py-4 dark:border-gray-800">
