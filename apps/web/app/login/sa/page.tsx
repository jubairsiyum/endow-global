...
export default function SALoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!session || (session.user as unknown as { role: string }).role !== 'SUPER_ADMIN') {
            ...
            <div className="px-6 py-6 sm:px-8 sm:py-7">
              ...
              >
                <h2 className="text-2xl font-black tracking-tight text-slate-950 sm:text-3xl">
                  Operations <span className="text-red-600">Control</span>
                </h2>
                <p className="mt-2 text-sm leading-relaxed text-slate-500">
                  Restricted access. Sign in to manage the platform infrastructure.
                </p>
