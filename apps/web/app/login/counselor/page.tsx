...
const ALLOWED_ROLES: UserRole[] = [UserRole.COUNSELOR, UserRole.ADMIN, UserRole.SUPER_ADMIN]
const DASHBOARD_PATH = '/counselor'
const PORTAL_LABEL = 'Counselor'
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await authClient.signIn.email({
        ...
        password,
        fetchOptions: {
          headers: { 'x-endow-login-portal': 'counselor' },
        },
      })
