            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
              ...
              {courses.length === 0 ? (
                ...
                <div className="divide-y divide-gray-100 px-5 pb-4">
                  {courses.map((c: any) => (
                    <Link key={c.id} href={`/institutions/${uni.slug}/${(c.level || 'postgraduate').toLowerCase()}/${c.slug}`} className="flex items-center justify-between py-3 group -mx-2 px-2 rounded-lg hover:bg-gray-50 transition-colors">
