    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 text-[11px]" style={{ color: '#6b7280' }}>
          ...
          <span style={{ color: '#6b7280' }}>{arcs.length} active routes</span>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          {isLoading ? (
            <>
              ...
              <p className="mt-3 text-[12px]" style={{ color: '#6b7280' }}>Loading network data...</p>
            </>
          ) : (
            <>
              <div className="flex h-12 w-12 items-center justify-center rounded-full" style={{ background: 'rgba(136,144,168,0.06)' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/></svg>
              </div>
              <p className="mt-3 text-[13px] font-medium" style={{ color: '#6b7280' }}>No network data yet</p>
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Active pulse on arcs â€” small dots traveling along paths */}
          {!reducedMotion &&
        ...
        <AnimatePresence>
          {hoveredNode && (
            ...
            >
              ...
              <div className="mt-1 flex items-center gap-3 text-[11px]" style={{ color: '#6b7280' }}>
                <span>
