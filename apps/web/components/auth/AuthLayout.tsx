  ...
  return (
    <AuthProvider initialMode={currentMode}>
      <div className="min-h-screen overflow-x-clip bg-[#f7f2ec] text-slate-950">
        ...
        <main className="lg:pb-18 relative isolate flex w-full items-start justify-center px-4 pb-12 pt-24 sm:px-6 sm:pb-14 sm:pt-28 lg:min-h-[calc(100svh-5rem)] lg:px-8 lg:pt-32">
          <BackgroundDecor />
          ...
          <div className="relative z-10 grid w-full max-w-7xl items-start gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(390px,0.72fr)] lg:gap-12 xl:gap-16">
