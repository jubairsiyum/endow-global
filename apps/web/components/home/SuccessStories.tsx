...
const stories = [
  ...
  },
  {
    ...
    quote:
      'From university selection to visa prep, every step was handled professionally. The AI matching found programs I hadn\'t considered — and they were perfect fits.',
    rating: 5,
    initials: 'AH',
    bg: 'bg-blue-50',
    color: 'text-blue-600',
  },
  {
    ...
    quote:
      'I was overwhelmed by the application process. Endow\'s platform organized everything — documents, deadlines, interviews. Now I\'m studying in Helsinki!',
    rating: 5,
    initials: 'LW',
    bg: 'bg-cyan-50',
    color: 'text-cyan-600',
