  ...
  return (
    ...
    >
      <header className="mb-4 flex items-start justify-between">
        ...
        <Link href="/dashboard/appointments" className={viewAllLink}>
        ...
        <ul className="space-y-3">
          {sessions.slice(0, 3).map((s, i) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-3.5 transition-all hover:border-gray-200 hover:shadow-md dark:border-gray-800 dark:bg-[#1a1d25] dark:hover:border-gray-700">
                  {date && (
                    <div className="flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-xl bg-rose-50 dark:bg-rose-500/10">
                      <span className="font-display text-lg font-bold leading-none text-rose-600 dark:text-rose-300">{format(date, 'd')}</span>
                  ...
                  {s.meetingUrl ? (
                    <a
                      ...
                      className="shrink-0 rounded-lg bg-rose-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-rose-700"
                    >
                      Join
                    </a>
                  ) : null}
