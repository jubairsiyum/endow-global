...
export const mockTimeline: TimelineStep[] = [
  { id: 'personal', label: 'Personal Info', description: 'Profile & academic history', currentIndex: 1 },
  { id: 'documents', label: 'Documents', description: 'Transcripts, SOP, references', currentIndex: 1 },
...
export const mockDocuments: MockDocument[] = [
  ...
  { id: 'd6', label: 'Financial evidence',   status: 'rejected', updatedAt: '3 days ago', rejectionReason: 'Bank statement older than 30 days' },
...
export const mockQuickActions: QuickActionItem[] = [
  { id: 'upload',    label: 'Upload Document',  description: 'Add a new file',          href: '/dashboard/documents' },
  { id: 'message',   label: 'Message Agent',    description: 'Reach your counselor',    href: '/dashboard/messages' },
  { id: 'consult',   label: 'Book Consultation',description: 'Schedule a 1:1 session',  href: '/dashboard/appointments' },
  { id: 'checklist', label: 'Download Checklist',description: 'Visa document list',     href: '/dashboard/documents' },
]
