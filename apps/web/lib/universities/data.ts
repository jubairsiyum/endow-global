...
export const universities: University[] = [
  {
    ...
    livingCost: 800,
    description:
      "Leading South Korean university focused on innovation and global education.",
    highlights: [
  ...
  },
  {
    ...
    livingCost: 900,
    description:
      "Premier coastal university with exceptional maritime and engineering programs.",
    highlights: [
  ...
  },
  {
    ...
    livingCost: 800,
    description:
      "National university excelling in engineering, agriculture, and natural sciences.",
    highlights: [
      "Government-funded",
      "Research excellence",
      "Affordable tuition",
  ...
  },
  {
    ...
    livingCost: 700,
    description:
      "Cost-effective university with diverse programs and strong industry connections.",
    highlights: [
      "Most affordable",
      "Business focus",
      "Practical training",
...
export const countries: Country[] = [
  {
    ...
    flag: "🇰🇷",
    description:
      "Tech-forward nation with world-class universities and vibrant culture.",
  },
  {
    name: "USA",
    code: "US",
...
export const scholarships: Scholarship[] = [
  ...
  },
  {
    ...
    daysToDeadline: 27,
    description:
      "Talent-based scholarship for students with exceptional achievements.",
  },
  {
    id: "sejong-partial",
    universityId: "sejong",
...
export const studentStories: StudentStory[] = [
  ...
  },
  {
    ...
    country: "South Korea",
    image:
      "https://images.unsplash.com/photo-1507539803528-15265d5479d2?w=400&h=400&fit=crop",
    review:
