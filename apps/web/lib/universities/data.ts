...
export const universities: University[] = [
  ...
  // ─── Australia ──────────────────────────────────────────
  {
    ...
    banner: '/universities/hanseo-university.png',
    ranking: 18,
    tuition: { min: 22000, max: 45000, currency: 'USD' },
    scholarship: 65,
    visaSuccessRate: 92,
    employmentRate: 88,
    intakeDeadline: '2026-06-30',
    daysToIntake: 37,
    programs: ['Engineering', 'Business', 'Medicine', 'Law', 'Arts & Social Sciences'],
    ieltsRequirement: 6.5,
    gpaRequirement: 3.2,
    dormitoryFee: 3500,
    livingCost: 1800,
    description: 'Australia\'s oldest university, ranked among the world\'s top 20. Known for research excellence and beautiful sandstone campus.',
    highlights: [
  ...
  },
  {
    ...
    banner: '/universities/daejin-university.png',
    ranking: 14,
    tuition: { min: 25000, max: 48000, currency: 'USD' },
    scholarship: 60,
    visaSuccessRate: 93,
    employmentRate: 90,
    intakeDeadline: '2026-07-10',
    daysToIntake: 47,
    programs: ['Medicine', 'Engineering', 'Business', 'IT', 'Architecture'],
    ieltsRequirement: 6.5,
    gpaRequirement: 3.3,
    dormitoryFee: 3800,
    livingCost: 1900,
    description: 'Australia\'s leading research university in the heart of Melbourne. Consistently ranked #1 in Australia.',
    highlights: [
      '#1 in Australia',
      'Innovation hub',
  ...
  },
  {
    ...
    banner: '/universities/busan-university.png',
    ranking: 30,
    tuition: { min: 20000, max: 40000, currency: 'USD' },
    scholarship: 70,
    visaSuccessRate: 94,
    employmentRate: 87,
    intakeDeadline: '2026-07-15',
    daysToIntake: 52,
    programs: ['Political Science', 'Engineering', 'Computer Science', 'Economics', 'Physics'],
    ieltsRequirement: 6.5,
    gpaRequirement: 3.0,
    dormitoryFee: 3000,
    livingCost: 1600,
    description: 'Australia\'s national research university, located in the capital. Known for policy studies and STEM research.',
    highlights: [
      'National university',
      'Policy & governance',
      'Research funding',
...
export const scholarships: Scholarship[] = [
  ...
  {
    id: 'melbourne-excellence',
    universityId: 'melbourne',
    universityName: 'University of Melbourne',
    percentage: 40,
    requirements: 'IELTS 6.5+, GPA 3.3+',
    ieltsRequirement: 6.5,
    deadline: '2026-07-10',
    daysToDeadline: 47,
    description: 'Graduate scholarship for outstanding academic achievement.',
  },
  {
    id: 'anu-research',
    universityId: 'anu',
    ...
    percentage: 60,
    requirements: 'IELTS 6.5+, GPA 3.2+, Research proposal',
    ieltsRequirement: 6.5,
    deadline: '2026-07-15',
    daysToDeadline: 52,
    description: 'Research scholarship for postgraduate students in STEM fields.',
  },
]
...
export const studentStories: StudentStory[] = [
  ...
  // ─── Australia Student Stories ────────────────────────
  {
    ...
    review:
      'The research facilities are world-class. Sydney is an incredible city for international students with endless opportunities.',
    scholarship: 50,
    visaApproval: true,
    rating: 5,
  },
  {
    ...
    review:
      'Melbourne consistently ranks as the most livable city. The university support for international students is outstanding.',
    scholarship: 40,
    visaApproval: true,
    rating: 5,
  },
  {
    ...
    review:
      'Small class sizes and direct access to professors made my research experience truly exceptional.',
    scholarship: 60,
    visaApproval: true,
    rating: 5,
  },
